...
# [TDD] ONNX Export — 모델 변환

> **목적**: `onnx_export.py`의 동작을 BDD/TDD로 정의한다.
> **테스트 파일**: `src/tests/unit/test_onnx_export.py`, `src/tests/integration/test_onnx_integration.py`
> **상태**: 🔴 Failing — 구현 전
...
### Feature: GrayspotModel → ONNX 변환

**Scenario 1: 유효한 Phase 2 체크포인트 → ONNX 생성**
```
...
**Scenario 2: ONNX 모델 입출력 shape 검증**
```
...
| 문서 | 관계 |
| --- | --- |
| [SSOT_Artifacts.md](../SSOT/SSOT_Artifacts.md) | ONNX 산출물 정의 |
| [Contract_artifact_boundary.md](../Contract/Contract_artifact_boundary.md) | export_to_onnx() API 계약 |
| [Contract_model_boundary.md](../Contract/Contract_model_boundary.md) | GrayspotModel 구조 |
