...
def minimal_cfg():
    return {
        ...
        "phase0": {
            "projection_dim": 128, "hidden_dim": 256, "temperature": 0.1,
            "epochs": 1, "batch_size": 2, "learning_rate": 1e-3, "weight_decay": 1e-5,
            "augmentation": {"flip_prob": 0.5, "blur_prob": 0.5, "crop_prob": 0.5,
                             "color_jitter": 0.4, "crop_scale_min": 0.6,
                             "crop_scale_max": 1.0, "contrast_scale_min": 0.8,
                             "contrast_scale_max": 1.2, "blur_kernels": [3, 5]},
        },
        "phase2": {
            "dropout": 0.3, "hidden_dim": 256, "epochs": 1, "batch_size": 2,
            "learning_rate": 1e-4, "weight_decay": 1e-4, "oversample": False,
            "early_stopping": {"enabled": False, "patience": 5, "min_delta": 1e-4},
            "augmentation": {"flip_prob": 0.0, "brightness_prob": 0.0, "noise_prob": 0.0},
        },
        "evaluation": {
            "targets": {"overall_accuracy": 0.90, "per_color_accuracy": 0.85,
                        "per_class_f1": 0.80, "mae": 0.50},
            "swing_thresholds": {"acc_retry": 0.80, "f1_retry": 0.70, "mae_retry": 0.80},
        },
        "storage": {
            "data_root": "data_set", "labeled_dir": "data_set/labeled",
            "models_dir": "data_set/models", "reports_dir": "data_set/reports",
            "logs_dir": "outputs/logs",
        },
        "train": {"seed": 42},
        "inference": {
            "confidence_thresholds": {"auto_accept": 0.8, "warn_threshold": 0.5, "manual_review": 0.3},
        },
