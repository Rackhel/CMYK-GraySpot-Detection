...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "header_hint":      {"ko": "이미지를 드래그하거나 버튼으로 선택하세요",
    ...
    "ckpt_placeholder": {"ko": "(비어 있으면 자동 탐지)",    "en": "(auto-detect if empty)"},
    "tooltip_browse":   {"ko": "파일 탐색",                 "en": "Browse file"},
    "tooltip_auto":     {"ko": "자동 탐지",                 "en": "Auto-detect"},
    "tooltip_detect_all":{"ko":"models_dir 에서 4채널 체크포인트를 자동으로 찾습니다",
    ...
    "toolbar_placeholder":{"ko":"파일을 선택하거나 드래그하세요",
                           "en":"Select or drag an image here"},

    # ── Result panel ──────────────────────────────────────────────────────────
    "lbl_preview":      {"ko": "미리보기",                  "en": "Preview"},
    "preview_hint":     {"ko": "이미지를 선택하거나\n드래그 & 드롭 하세요",
                         "en": "Select an image\nor drag & drop here"},
