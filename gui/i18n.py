...
_T: dict[str, dict[str, str]] = {
    ...
    "grp_preprocess_params": {
        "ko": "전처리 파라미터 / Preprocessing Parameters",
        "en": "Preprocessing Parameters",
    },
    "grp_data_pipeline": {
        "ko": "데이터 파이프라인 / Data Pipeline Scripts",
        "en": "Data Pipeline Scripts",
    },
    # ── Buttons ───────────────────────────────────────────────────────────
    ...
    "btn_save_parameters": {"ko": "💾  파라미터 저장", "en": "💾  Save Parameters"},
    "btn_holdout": {
        "ko": "🔒  Holdout 분리 실행",
        "en": "🔒  Prepare Holdout (dry-run)",
    },
    "btn_generate_synthetic": {
        "ko": "🧪  합성 이미지 생성",
        "en": "🧪  Generate Synthetic (dry-run)",
    },
    ...
    "btn_snapshot": {"ko": "📸  현재 설정 스냅샷 저장", "en": "📸  Save Snapshot"},
    "grp_before_after": {
        "ko": "Before / After 비교",
    ...
    "lbl_train_data_location": {
        "ko": "학습 데이터 위치",
        "en": "Training Data Location",
    },
    "lbl_image_size_px": {"ko": "Image Size (px)", "en": "Image Size (px)"},
    "lbl_normalize_mean": {"ko": "Normalize Mean", "en": "Normalize Mean"},
    "lbl_normalize_std": {"ko": "Normalize Std", "en": "Normalize Std"},
    "lbl_train": {"ko": "Train", "en": "Train"},
    "lbl_val": {"ko": "Val", "en": "Val"},
    "lbl_test": {"ko": "Test", "en": "Test"},
    "lbl_split_ratio": {"ko": "Split Ratio", "en": "Split Ratio"},
    "lbl_count": {"ko": "Count", "en": "Count"},
    ...
    "grp_backbone": {"ko": "Backbone 설정", "en": "Backbone Configuration"},
    "grp_head": {"ko": "Head 설정 / Classification Head", "en": "Head Configuration"},
    "grp_phase_hp": {"ko": "Phase 하이퍼파라미터", "en": "Phase Hyperparameters"},
    "grp_run_train": {"ko": "학습 실행 / Run Training", "en": "Run Training"},
    "grp_extract_embeddings": {
        "ko": "임베딩 추출 / Extract Embeddings",
        "en": "Extract Embeddings",
    },
    "grp_run_eval": {"ko": "평가 실행 / Run Evaluation", "en": "Run Evaluation"},
    "tab_scatter": {"ko": "🗺️  t-SNE 산점도", "en": "🗺️  t-SNE Scatter"},
    "tab_purity": {"ko": "📊  레벨 순도", "en": "📊  Level Purity"},
    "tab_similar": {"ko": "🔍  유사 이미지", "en": "🔍  Similar Images"},
    "tab_correction": {"ko": "✏️  라벨 교정", "en": "✏️  Label Correction"},
    "lbl_per_channel_summary": {
        "ko": "채널별 비교 / Per-Channel Summary",
        "en": "Per-Channel Summary",
    },
    # ── Theme names ───────────────────────────────────────────────────────
